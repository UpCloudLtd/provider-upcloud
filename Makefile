...
xpkg.build.provider-upcloud: do.build.images
...
cleanup-apis: 
	find apis -type f ! -regex '^apis/\(v1alpha1\|v1beta1\)/.*$$' ! -name 'zz_register.go' ! -name 'generate.go' -delete;
